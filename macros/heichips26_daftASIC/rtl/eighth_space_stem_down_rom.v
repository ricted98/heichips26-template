...
module eighth_space_stem_down_rom (address, data);
     ...
     always @(address) begin
          case (address)
                ...
                7: data = 32'b00000000011111111111111110000000;
                8: data = 32'b00000000011111111111111110000000;
                9: data = 32'b00000000011111111111111110000000;
               ...
               30: data = 32'b00000000011100000001100000000000;
               31: data = 32'b00000000011100000001100000000000;
               32: data = 32'b00000000011100000011100000000000;
               33: data = 32'b00000000011100000011100000000000;
               34: data = 32'b00000000011100000111000000000000;
               35: data = 32'b00000000011100000111000000000000;
               36: data = 32'b00000000011100001110000000000000;
               37: data = 32'b00000000011100001110000000000000;
               38: data = 32'b00000000011100011100000000000000;
               39: data = 32'b00000000011100011100000000000000;
               40: data = 32'b00000000011100111000000000000000;
               41: data = 32'b00000000011101111000000000000000;
               42: data = 32'b00000000011111110000000000000000;
               43: data = 32'b00000000011111100000000000000000;
