...
module half_space_stem_down_rom (address, data);
     ...
     always @(address) begin
          case (address)
                ...
                3: data = 32'b00000000000111000000111000000000;
                4: data = 32'b00000000001110000000011100000000;
                5: data = 32'b00000000001100000000001100000000;
               ...
               11: data = 32'b00000000011100000000001100000000;
               12: data = 32'b00000000011110000000011100000000;
               13: data = 32'b00000000011111000000111000000000;
