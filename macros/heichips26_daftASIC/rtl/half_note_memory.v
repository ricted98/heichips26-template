...
module half_note_memory (address, data);
     ...
     half_space_stem_up_rom __space_stem_up_rom (address[5:0], data_space_stem_up);
     half_line_stem_up_rom __line_stem_up_rom (address[5:0], data_line_stem_up);
     half_space_stem_down_rom __space_stem_down_rom (address[5:0], data_space_stem_down);
     half_line_stem_down_rom __line_stem_down_rom (address[5:0], data_line_stem_down);
